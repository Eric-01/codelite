...
RenameFileBaseDlg::RenameFileBaseDlg( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_textCtrlReplaceWith = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY );
    bSizer3->Add( m_textCtrlReplaceWith, 1, wxALL|wxEXPAND, 5 );
    
    mainSizer->Add( bSizer3, 0, wxEXPAND, 5 );
    
    m_staticText1 = new wxStaticText( this, wxID_ANY, _("The following files will be updated:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    // Connect Events
    m_checkListMatches->Connect( wxEVT_COMMAND_LISTBOX_SELECTED, wxCommandEventHandler( RenameFileBaseDlg::OnFileSelected ), NULL, this );
    m_checkListMatches->Connect( wxEVT_COMMAND_CHECKLISTBOX_TOGGLED, wxCommandEventHandler( RenameFileBaseDlg::OnFileToggeled ), NULL, this );
}
